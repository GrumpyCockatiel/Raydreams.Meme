...
/// <summary></summary>
/// <remarks>http://en.wikipedia.org/wiki/Whitespace_character#Unicode</remarks>
public static class CharExtensions
{
    public static bool IsUnicodeSpace(this char ch)
    {
    ...
    public static bool IsUnicodeNonBreaking(this char ch)
    {
    ...
    public static bool IsCJKUnicode(this char ch)
    {
